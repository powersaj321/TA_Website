                    ...
                    <tbody>
                        <?php
                            for ($i=0; $i < count($questions); $i++) {
                                ...
                                echo "<td><textarea class='form-control' name='question' readonly='readonly' rows='1'>" . $questions[$i]->getQuestion() . "</textarea></td>";
                                echo "<td><textarea class='form-control' name='answer' value='' rows='1'></textarea></td>";
